  ...
  <div class="pymeter-component-container">
    ...
    >
      ...
      <el-form-item label="延迟时间：" prop="property.ConstantTimer__delay">
        <el-input v-model="elementInfo.property.ConstantTimer__delay" clearable :readonly="queryMode">
...
export default {
  ...
  methods: {
    ...
    async createControllerElement() {
      ...
      // 关闭tab
      this.$store.commit('pymeter/removeTab', { editorNo: 'UNSAVED_CONSTANT_TIMER' })
      // 重新查询脚本
      this.$store.commit('pymeter/refreshElementTreeNow')
    }
  }
