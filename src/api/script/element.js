...
export const queryElementsChildren = params => request.get(
  '/script/elements/children',
  {
    params: params,
...
export const queryHttpHeaderTemplateRefs = params => request.get('/script/element/http/header/template/refs', { params: params })
