...
export const queryHttpHeaderTemplateList = params => request.get('/script/http/header/template/list', { params: params })

export const queryHttpHeaderTemplateAll = params => request.get('/script/http/header/template/all', { params: params })
...
export const queryHttpHeadersByTemplate = params => request.get('/script/http/headers/by/template', { params: params })
...
export const copyHttpHeaderTemplateToWorkspace = data => request.post('/script/http/header/template/copy/to/workspace', data)

export const moveHttpHeaderTemplateToWorkspace = data => request.post('/script/http/header/template/move/to/workspace', data)
