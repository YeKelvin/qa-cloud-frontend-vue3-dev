...
export const enableVariable = data => request.patch('/script/variable/enable', data)

export const disableVariable = data => request.patch('/script/variable/disable', data)

export const updateCurrentValue = data => request.patch('/script/variable/current/value', data)

export const queryVariablesByDataset = params => request.get('/script/variables/by/dataset', { params: params })

export const queryVariables = params => request.get('/script/variables', { params: params })
