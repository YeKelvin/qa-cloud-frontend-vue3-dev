...
const totalData = computed(() => {
  return [
    {
      totalType: '总数',
      groupTotal: props.details.successfulGroupsTotal + props.details.failedGroupsTotal,
      samplerTotal: props.details.successfulSamplersTotal + props.details.failedSamplersTotal
    },
    {
      totalType: '成功总数',
      groupTotal: props.details.successfulGroupsTotal,
      samplerTotal: props.details.successfulSamplersTotal
    },
    {
      totalType: '失败总数',
      groupTotal: props.details.failedGroupsTotal,
      samplerTotal: props.details.failedSamplersTotal
    },
    {
      totalType: '成功率',
      groupTotal: successRate(props.details.successfulGroupsTotal, props.details.failedGroupsTotal),
      samplerTotal: successRate(props.details.successfulSamplersTotal, props.details.failedSamplersTotal)
    },
    {
      totalType: '平均响应时间',
      groupTotal: props.details.avgGroupsElapsedTime,
...
onMounted(() => {
  ...
  setPieChartData([
    { value: props.details.successfulGroupsTotal, name: '成功', itemStyle: { color: '#44B197' } },
    { value: props.details.failedGroupsTotal, name: '失败', itemStyle: { color: '#FF7676' } }
  ])
})
